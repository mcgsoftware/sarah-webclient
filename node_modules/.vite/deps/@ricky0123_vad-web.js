...
var require_ort_min = __commonJS({
  "node_modules/onnxruntime-web/dist/ort.min.js"(exports, module) {
    ...
    var ort = (() => {
      ...
      var lt = (e) => Gu($n({}, "__esModule", { value: true }), e);
      var St, Ze, We, Hu, br, xn = k(() => {
        "use strict";
        St = /* @__PURE__ */ new Map(), Ze = [], We = (e, t, n) => {
      ...
      var An = {};
      rt(An, { InferenceSession: () => Lr, TRACE: () => pt, TRACE_EVENT_BEGIN: () => Ue, TRACE_EVENT_END: () => Re, TRACE_FUNC_BEGIN: () => ye, TRACE_FUNC_END: () => he, Tensor: () => xe, env: () => te, registerBackend: () => We });
      var _e = k(() => {
        "use strict";
        _r();
        xr();
      ...
      var Pn, zn, Rt, ro, Xu, Yu, Ju, Et, ne, Ge = k(() => {
        "use strict";
        At();
      ...
      var He, Ee, qe, ot, ht, Lt, Wt, Bn, L = k(() => {
        "use strict";
        He = (e) => {
          switch (e) {
            case "int8":
  ...
  fn get_${e}(${E}) -> ${l} {
    return get_${e}ByIndices(${I(N)});
          ...
          }, G = (E) => s < 2 ? Q(E) : (m.getByIndices = true, m.indicesToOffset = true, `get_${e}ByIndices(${E})`), H = s < 2 ? "" : `
...
`);
          ...
          }, setByOffset: U, setByIndices: (E, N) => s < 2 ? U(E, N) : (m.setByIndices = true, m.indicesToOffset = true, `set_${e}ByIndices(${E}, ${N});`), get: V, getByOffset: Q, getByIndices: G, usage: r, name: e, strides: y, shape: b, rank: s };
...
`);
  ...
  ${h.mainStart()}
    ...
    ${y.setByOffset("global_idx", b.getByIndices("aIndices"))}
      ...
      var Be, Cd, en, Kn, De, Ad, Ed, kd, Pd, zd, Bd, Dd, Od, Md, Ud, Oe, Lo, Wo, Go, Ho, qo, Fo, Ko, jo, Zo, Qo, Jt = k(() => {
        "use strict";
        L();
        F();
        ie();
...
`)}
          ...
          let n = [];
          return e[1].dims[0] > 0 && e[1].getBigInt64Array().forEach((r) => n.push(Number(r))), W({ axes: n, keepDims: t.keepDims, noopWithEmptyAxes: t.noopWithEmptyAxes });
        }, De = (e, t, n, r) => {
...
var best_index : i32 = 0;`, `if (${r.getByIndices("input_indices")} ${t.selectLastIndex > 0 ? ">=" : ">"} value) {
      ...
      var Rd, Zn, Vd, Nd, Ld, it, Wd, ti, tn = k(() => {
        "use strict";
        L();
        F();
        Qt();
      ...
      ${s ? `
        for (var total_seq_id: u32 = seq_causal_length; total_seq_id + local_offset < uniforms.total_sequence_length; total_seq_id++) {
          ...
          let I = (A) => {
            ...
            let V = ce(1, b), G = [{ name: "M", type: "u32" }, { name: "K", type: "u32" }, { name: "N", type: "u32" }, { name: "num_heads", type: "u32" }, { name: "head_size", type: "u32" }, { name: "alpha", type: "f32" }, { name: "past_sequence_length", type: "u32" }, { name: "kv_sequence_length", type: "u32" }, { name: "n_reps", type: "u32" }];
            return `
  const TILE_SIZE = ${g}u;
...
`;
    ...
    `;
          ...
          let D = (U) => {
            let Q = l.length, O = Yt("batchDims", e[0].dataType, Q, 1), M = re(e[0].dataType), V = S("a", e[0].dataType, v, _), G = S("b", e[1].dataType, T, _), H = C("result", e[0].dataType, I.length, _), X = [V, G];
            if (R) {
              let N = o ? _ : 1;
            ...
            Ae(t, oe);
            let de = re(H.type.tensor), q = Ie(t, H.type.value, de), E = ll(_, R, q, [O, V, G, H], o);
            return `
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${v}) {
      ...
      setOutputAtCoords(coords[0], coords[1], coords[2], coords[3], value);
          ...
          let O = (M) => {
            ...
            Ae(t, V);
            let G = h ? 4 : 1, H = re(e[0].dataType), X = `
      ...
      }`, oe = S("x", e[0].dataType, e[0].dims.length, v === 3 ? 1 : v), de = S("w", e[1].dataType, e[1].dims.length, G), q = [oe, de], E = C("result", e[0].dataType, n.length, G);
            if (s) {
              let N = S("bias", e[2].dataType, e[2].dims.length, G);
              q.push(N), X += `
    ...
    ${de}}`;
      ...
      var Sl, As, Es, ks = k(() => {
        ...
        Sl = (e, t, n, r) => {
          ...
          return W({ exclusive: t, reverse: n });
        };
      });
...
`);
  ...
  ${y.mainStart()}
    ...
    ${h.setByOffset("global_idx", m.getByIndices("aIndices"))}
        ...
        }, zs = (e) => W({ blocksize: e.blocksize, mode: e.mode, format: e.format });
      });
  ...
  ${p.mainStart()}
    ...
    input_slice_offsets_data[global_idx] =  base_offset + u32(relative_slice_offset);
      ...
      var Rl, Vl, Qs, Xs, Ys = k(() => {
        ...
        }, Xs = (e) => W({ blockSize: e.blockSize, gatherAxis: e.gatherAxis, quantizeAxis: e.quantizeAxis });
      });
  ...
  ${c.mainStart()}
    ${c.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      ${Ql(s, a, t)}
        ...
        }, sa = (e) => W({ alignCorners: e.align_corners, mode: e.mode, paddingMode: e.padding_mode, format: e.format });
      });
      var be, ec, da, ua, tc, wt, la, ar = k(() => {
        ...
        }, da = (e) => W({ ...e }), ua = W({ perm: [0, 2, 1, 3] }), tc = (e, t, n, r, o, i, s) => {
    ...
    qkv_with_bias[global_idx] = qkv[global_idx] + bias[bias_offset_idx];
      ...
      var nc, rc, oc, ic, ur, ca, pa, dr = k(() => {
        ...
        nc = (e) => {
          ...
          return e[1].dims[0] > 0 && (e[1].getBigInt64Array().forEach((o) => n.push(Number(o))), r = n.length), W({ numOutputs: r, axis: t.axis, splitSizes: n });
        }, oc = (e) => `
...
`)}
  ...
  ${m.mainStart()}
    ...
    writeBufferData(output_number, indices, global_idx);
          ...
          return W({ axis: t, numOutputs: r, splitSizes: n });
        };
      });
      var sc, pn, ma, lr = k(() => {
        "use strict";
        ...
        ${b.mainStart(Je)}
          ...
          return { name: "RotaryEmbedding", shaderCache: { hint: W({ interleaved: n }).cacheKey, inputDependencies: ["rank", "rank", "rank", "rank"] }, getShaderSource: h, getRunData: () => ({ outputs: [{ dims: e[0].dims, dataType: e[0].dataType }], dispatchGroup: { x: Math.ceil(x.size(p) / Je) }, programUniforms: m }) };
        }, ma = (e, t) => {
  ...
  `;
          ...
          let r = e.inputs[0], o = e.inputs[1] && e.inputs[1].dims.length > 0 ? e.inputs[1] : void 0, i = e.inputs[2] && e.inputs[2].dims.length > 0 ? e.inputs[2] : void 0, s = e.inputs[3] && e.inputs[3].dims.length !== 0 ? e.inputs[3] : void 0, a = e.inputs[4] && e.inputs[4].dims.length !== 0 ? e.inputs[4] : void 0, u = e.inputs.length > 4 ? e.inputs[5] : void 0, d = e.inputs.length > 5 ? e.inputs[6] : void 0, l = n.kvNumHeads ? n.kvNumHeads : n.numHeads, c = W({ axis: 2, numOutputs: 3, splitSizes: [n.numHeads * n.headSize, l * n.headSize, l * n.headSize] }), [p, f, m] = !o && !i ? e.compute(ur([r], c), { inputs: [r], outputs: [-1, -1, -1] }) : [r, o, i], h, b;
          if (t.doRotary) {
            let w = e.compute(dc(n.batchSize, n.sequenceLength, u, d), { inputs: [u, d], outputs: [-1] })[0], v = e.inputs[7], $ = e.inputs[8], T = W({ interleaved: t.rotaryInterleaved !== 0, numHeads: n.numHeads, rotaryEmbeddingDim: 0, scale: t.scale }), I = [p, w, v, $], A = [-1];
            h = e.compute(pn(I, T), { inputs: I, outputs: A })[0], I.splice(0, 1, f);
            let z = W({ interleaved: t.rotaryInterleaved !== 0, numHeads: n.kvNumHeads, rotaryEmbeddingDim: 0, scale: t.scale });
  ...
  ${v.mainStart()}
    ...
    ${g ? "inv_std_output[global_idx] = inv_std_dev" : ""};
      ...
      var hc, gc, yc, Sa, Ta, Ia = k(() => {
        ...
        hc = (e, t) => {
          ...
          let T = (I) => {
            ...
            Q && U.push(Q);
            let O = $.length, M = C("output", e[0].dataType, O, m), V = re(e[0].dataType), G = (() => {
              switch (p) {
                case 1:
                  return `array<${V}, 8>`;
                case 2:
        ...
        ${I.mainStart([g, 1, 1])}
          ...
          let z = (R) => {
            ...
            V && M.push(V);
            let G = A.length, H = C("output", e[0].dataType, G), X = re(e[0].dataType), oe = () => {
              switch (p) {
                case 1:
                  return `
      ...
      var mn, Ea, ka, Pa, za, Ic, Cc, Ba, Da, Oa, Ma, Ua, Ra, Va, Na, La, Wa, Ga, Ha, qa = k(() => {
        "use strict";
        _e();
        L();
        F();
    ...
    `, a = "", u = S("x", t.dataType, t.dims.length), d = ["rank"], [l, c, p, f, m] = ka(i, o);
      ...
      ${$.setByOffset("global_idx", `${$.type.value}(x_value - zero_point_value) * scale_value`)};
        ...
        }, Ka = (e) => W({ axis: e.axis, blockSize: e.blockSize });
      });
      var Pc, zc, Za, Qa = k(() => {
        "use strict";
        _e();
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${Bc(t.reduction, "output[data_offset + i]", "value", m.type.value)}
        ...
        }, Xa = (e) => W({ reduction: e.reduction }), Ya = (e, t) => {
          e.compute(Dc(e.inputs, t), { inputs: [e.inputs[1], e.inputs[2]], outputs: [] });
        };
      });
      var Oc, Mc, Uc, eu, Rc, Vc, Nc, Lc, Wc, Gc, Hc, qc, tu, Fc, Kc, jc, Zc, Qc, nu, ru, ou = k(() => {
        "use strict";
        L();
        F();
        ie();
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${m} {
    ...
    depth = max(0, min(depth, ${n[a]} - 1));
      ...
      return (x111 * dx2 * dy2 * dz2 + x112 * dx2 * dy2 * dz1 + x121 * dx2 * dy1 *dz2 + x122 * dx2 * dy1 * dz1 +
          ...
          r.length === 0 && (d = s.map((g, _) => g === 0 ? 1 : u[_] / g), t.keepAspectRatioPolicy !== "stretch" && (u = Wc(s, d, t)));
...
`}
          ...
          return W({ antialias: t, axes: n, coordinateTransformMode: r, cubicCoeffA: o, excludeOutside: i, extrapolationValue: s, keepAspectRatioPolicy: a, mode: u, nearestMode: d });
        };
      });
      var Xc, Yc, iu, su = k(() => {
        "use strict";
      ...
      var Jc, fn, ep, au, tp, np, uu, du, lu = k(() => {
        ...
        Jc = (e, t) => {
          ...
          if (e.length > 1) {
            ...
            return o.length === 0 && (o = [...Array(e[0].dims.length).keys()]), W({ starts: n, ends: r, axes: o });
          } else return t;
        }, au = (e, t, n, r, o) => {
          let i = e;
      ...
      ${y.registerUniforms(m).declareVariables(p, c)}
        ...
        ${y.mainStart()}
          ...
          return W({ starts: t, ends: n, axes: r });
        };
      });
...
${a}`, d = r.createShaderModule({ code: u, label: t.name });
        ...
        mp = (e, t) => {
          ...
          try {
            ...
            if (p && !m) {
              ...
              for (let G = 0; G < h; G++) {
                let H = t[G];
                await s._OrtBindInput(O, l[H], _[G]) !== 0 && Y(`Can't bind input[${G}] for session=${e}.`);
              }
              for (let G = 0; G < b; G++) {
                let H = r[G];
                o[G]?.[3] ? ($.push(w[G]), s._OrtBindOutput(O, c[H], w[G], 0) !== 0 && Y(`Can't bind pre-allocated output[${G}] for session=${e}.`)) : s._OrtBindOutput(O, c[H], 0, V[H]) !== 0 && Y(`Can't bind output[${G}] to ${M[G]} for session=${e}.`);
              }
            ...
            for (let O = 0; O < b; O++) {
              ...
              let V = s.stackSave(), G = s.stackAlloc(4 * a), H = false, X, oe = 0;
              try {
                s._OrtGetTensorData(M, G, G + a, G + 2 * a, G + 3 * a) !== 0 && Y(`Can't access output tensor data on index ${O}.`);
                let q = a === 4 ? "i32" : "i64", E = Number(s.getValue(G, q));
                oe = s.getValue(G + a, "*");
                let N = s.getValue(G + a * 2, "*"), se = Number(s.getValue(G + a * 3, q)), ve = [];
                ...
                if (X === "string") {
                  ...
                  if (qe(E, ge) === void 0 || !Wt(X)) throw new Error(`Unsupported data type: ${X}`);
      ...
      var wp = {};
      rt(wp, { InferenceSession: () => Lr, TRACE: () => pt, TRACE_EVENT_BEGIN: () => Ue, TRACE_EVENT_END: () => Re, TRACE_FUNC_BEGIN: () => ye, TRACE_FUNC_END: () => he, Tensor: () => xe, default: () => _p, env: () => te, registerBackend: () => We });
      _e();
      _e();
      _e();
      var Kr = "1.24.2";
    ...
    var ort = (() => {
      ...
      var It, At, Ot = E(() => {
        ...
        It = (e, t) => {
          ...
          if (o != null) {
            ...
            let l = i * r, c = 0, d = l, p = l * 2, w = -1;
            s === "RGBA" ? (c = 0, d = l, p = l * 2, w = l * 3) : s === "RGB" ? (c = 0, d = l, p = l * 2) : s === "RBG" && (c = 0, p = l, d = l * 2);
            for (let y = 0; y < i; y++) for (let O = 0; O < r; O++) {
              let m = (e.data[c++] - f[0]) * u[0], h = (e.data[d++] - f[1]) * u[1], B = (e.data[p++] - f[2]) * u[2], g = w === -1 ? 255 : (e.data[w++] - f[3]) * u[3];
              o.fillStyle = "rgba(" + m + "," + h + "," + B + "," + g + ")", o.fillRect(O, y, 1, 1);
            }
            if ("toDataURL" in n) return n.toDataURL();
            throw new Error("toDataURL is not supported");
          } else throw new Error("Can not access image data");
          ...
          if (n != null) {
            ...
            let c = i * r;
            if (t !== void 0 && (t.format !== void 0 && s === 4 && t.format !== "RGBA" || s === 3 && t.format !== "RGB" && t.format !== "BGR")) throw new Error("Tensor format doesn't match input tensor dims");
            let d = 4, p = 0, w = 1, y = 2, O = 3, m = 0, h = c, B = c * 2, g = -1;
            a === "RGBA" ? (m = 0, h = c, B = c * 2, g = c * 3) : a === "RGB" ? (m = 0, h = c, B = c * 2) : a === "RBG" && (m = 0, B = c, h = c * 2), o = n.createImageData(r, i);
            for (let T = 0; T < i * r; p += d, w += d, y += d, O += d, T++) o.data[p] = (e.data[m++] - l[0]) * f[0], o.data[w] = (e.data[h++] - l[1]) * f[1], o.data[y] = (e.data[B++] - l[2]) * f[2], o.data[O] = g === -1 ? 255 : (e.data[g++] - l[3]) * f[3];
          } else throw new Error("Can not access image data");
          return o;
        };
      });
      var Ke, Bt, Lt, Pt, Dt, _t, Ut = E(() => {
        ...
        Ke = (e, t) => {
          ...
          let a = t.format !== void 0 ? t.format : "RGBA", u = t.tensorFormat !== void 0 && t.tensorFormat !== void 0 ? t.tensorFormat : "RGB", f = n * o, l = u === "RGBA" ? new Float32Array(f * 4) : new Float32Array(f * 3), c = 4, d = 0, p = 1, w = 2, y = 3, O = 0, m = f, h = f * 2, B = -1;
          a === "RGB" && (c = 3, d = 0, p = 1, w = 2, y = -1), u === "RGBA" ? B = f * 3 : u === "RBG" ? (O = 0, h = f, m = f * 2) : u === "BGR" && (h = 0, m = f, O = f * 2);
          for (let T = 0; T < f; T++, d += c, w += c, p += c, y += c) l[O++] = (e[d] + s[0]) / i[0], l[m++] = (e[p] + s[1]) / i[1], l[h++] = (e[w] + s[2]) / i[2], B !== -1 && y !== -1 && (l[B++] = (e[y] + s[3]) / i[3]);
          ...
          if (n) {
            ...
            if (i) return new Promise((l, c) => {
              ...
              w.crossOrigin = "Anonymous", w.src = e, w.onload = () => {
                d.width = w.width, d.height = w.height, p.drawImage(w, 0, 0, d.width, d.height);
      ...
      var st, it, Me, nn, Fn, Nn, kn, Be, I, ee = E(() => {
        ...
        it = false, Me = false, nn = false, Fn = () => {
          ...
          let r = e.wasmPaths, i = typeof r == "string" ? r : void 0, s = r?.mjs, a = s?.href ?? s, u = r?.wasm, f = u?.href ?? u, l = e.wasmBinary, [c, d] = await tn(a, i, n > 1, !!l || !!f), p = false, w = [];
          if (t > 0 && w.push(new Promise((y) => {
            setTimeout(() => {
              p = true, y();
            }, t);
          })), w.push(new Promise((y, O) => {
            let m = { numThreads: n };
            if (l) m.wasmBinary = l;
            else if (f || i) m.locateFile = (h) => f ?? i + h;
            else if (a && a.indexOf("blob:") !== 0) m.locateFile = (h) => new URL(h, a).href;
            else if (c) {
              let h = Ce();
              h && (m.locateFile = (B) => h + B);
            }
            d(m).then((h) => {
              Me = false, it = true, st = h, y(), c && URL.revokeObjectURL(c);
            }, (h) => {
              Me = false, nn = true, O(h);
            });
          })), await Promise.race(w), p) throw new Error(`WebAssembly backend initializing failed due to timeout: ${t}ms`);
        }, I = () => {
          if (it && st) return st;
          throw new Error("WebAssembly is not initialized yet.");
        };
      ...
      var Hn, Le, Pe, ue, jn, dn, me, De, _e, ln, Ue, xe, ve, rt = E(() => {
        ...
        Hn = (e, t) => {
          ...
          try {
            ...
            let [c, d] = jn(i), p = !!t?.enableGraphCapture, w = [], y = [], O = [], m = [], h = [];
            for (let g = 0; g < c; g++) {
              let [T, U, M] = dn(i, g);
              T === 0 && S("Can't get an input name."), f.push(T);
              let v = r.UTF8ToString(T);
              w.push(v), O.push(U === 0 ? { name: v, isTensor: false } : { name: v, isTensor: true, type: Ne(U), shape: M });
            }
            for (let g = 0; g < d; g++) {
              let [T, U, M] = dn(i, g + c);
            ...
            return ue.set(i, [i, f, l, null, p, false]), [i, w, y, O, m];
          } catch (c) {
          ...
          let a = I(), u = a.PTR_SIZE, f = e[0], l = e[1], c = e[3], d = c, p, w;
          ...
          if (c === "gpu-buffer") {
            ...
            w = ae(ie(f), l);
            {
              let h = a.jsepRegisterBuffer;
              if (!h) throw new Error('Tensor location "gpu-buffer" is not supported without using WebGPU.');
              p = h(o, i, m, w);
            }
          } else if (c === "ml-tensor") {
            let m = e[2].mlTensor;
            w = ae(ie(f), l);
            let h = a.webnnRegisterMLTensor;
            if (!h) throw new Error('Tensor location "ml-tensor" is not supported without using WebNN.');
            p = h(o, m, ie(f), l);
          } else {
            let m = e[2];
            if (Array.isArray(m)) {
              w = u * m.length, p = a._malloc(w), n.push(p);
              for (let h = 0; h < m.length; h++) {
                if (typeof m[h] != "string") throw new TypeError(`tensor data at index ${h} is not a string`);
                a.setValue(p + h * u, F(m[h], n), "*");
              }
            } else {
              let h = a.webnnIsGraphInput, B = a.webnnIsGraphOutput;
              if (f !== "string" && h && B) {
                let g = a.UTF8ToString(r);
                if (h(o, g) || B(o, g)) {
                  let T = ie(f);
                  w = ae(T, l), d = "ml-tensor";
                ...
                } else w = m.byteLength, p = a._malloc(w), n.push(p), a.HEAPU8.set(new Uint8Array(m.buffer, m.byteOffset, w), p);
              } else w = m.byteLength, p = a._malloc(w), n.push(p), a.HEAPU8.set(new Uint8Array(m.buffer, m.byteOffset, w), p);
            }
          }
          let y = a.stackSave(), O = a.stackAlloc(4 * l.length);
          try {
            l.forEach((h, B) => a.setValue(O + B * u, h, u === 4 ? "i32" : "i64"));
            let m = a._OrtCreateTensor(ie(f), p, w, O, l.length, cn(d));
          ...
          if (!u) throw new Error(`cannot run inference. invalid session id: ${e}`);
          let f = u[0], l = u[1], c = u[2], d = u[3], p = u[4], w = u[5], y = t.length, O = o.length, m = 0, h = [], B = [], g = [], T = [], U = [], M = s.stackSave(), v = s.stackAlloc(y * a), de = s.stackAlloc(y * a), re = s.stackAlloc(O * a), lt = s.stackAlloc(O * a);
          try {
            [m, h] = rn(i), q("wasm prepareInputOutputTensor");
            ...
            s.webnnOnRunEnd?.(f), s.stackRestore(M), B.forEach((N) => s._OrtReleaseTensor(N)), g.forEach((N) => s._OrtReleaseTensor(N)), T.forEach((N) => s._free(N)), m !== 0 && s._OrtReleaseRunOptions(m), h.forEach((N) => s._free(N));
          }
        }, xe = (e) => {
          let t = I(), n = ue.get(e);
          if (!n) throw new Error("invalid session id");
        ...
        En = (e, t) => {
          ...
          async run(t, n, o) {
            ...
            Object.entries(t).forEach((d) => {
              let p = d[0], w = d[1], y = this.inputNames.indexOf(p);
              if (y === -1) throw new Error(`invalid input '${p}'`);
              r.push(w), i.push(y);
            });
            let s = [], a = [];
            Object.entries(n).forEach((d) => {
              let p = d[0], w = d[1], y = this.outputNames.indexOf(p);
